  ...
  return (
    <div className="fixed inset-0 z-40 grid place-items-end bg-slate-950/55 px-3 py-3 backdrop-blur-sm sm:place-items-center sm:px-4">
      <div className="card max-h-[92vh] w-full max-w-2xl overflow-y-auto shadow-2xl">
        <div className="flex items-center justify-between gap-3 border-b border-slate-200 bg-gradient-to-r from-slate-100/80 to-zinc-100/70 px-4 py-4 dark:border-slate-800 dark:from-slate-800/50 dark:to-zinc-800/40 sm:px-5">
